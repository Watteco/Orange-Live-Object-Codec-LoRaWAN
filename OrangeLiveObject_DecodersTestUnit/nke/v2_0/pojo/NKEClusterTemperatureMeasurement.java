...
@Data
@OutputPojo
public class NKEClusterTemperatureMeasurement extends NKEFrameHeader {
//0x0402 Temperature Measurement
	
	@FieldDescription(description = "Temperature of the remote sensor")
	public Measure measure;
	
	@FieldDescription(description = "The minimum value of temperature that the remote sensor is capable to measure")
	public Measure minimum;
	
	@FieldDescription(description = "The maximum value of temperature that the remote sensor is capable to measure")
