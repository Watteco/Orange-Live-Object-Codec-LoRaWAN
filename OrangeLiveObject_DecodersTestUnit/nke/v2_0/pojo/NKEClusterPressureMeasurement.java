...
@Data
@OutputPojo
public class NKEClusterPressureMeasurement extends NKEFrameHeader {

	
	@FieldDescription(description = "Pressure of the device")
	public Measure measure;
	
	@FieldDescription(description = "The minimum value of pressure of the device")
	public Measure minimum;
	
	@FieldDescription(description = "The maximum value of pressure of the device")
