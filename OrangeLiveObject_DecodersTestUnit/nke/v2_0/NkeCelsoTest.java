 ...
 */
@Slf4j
@DeviceDescription(name = "Watteco (NKE-Watteco) Celso 50-70-049 50-70-096 50-70-097", manufacturer = "WATTECO", docLink = "https://support.watteco.com/",
        version = { "1.0",
                "</h5>",
                "Cluster:<ul>",
...
public class NkeCelsoTest extends TestBase {
