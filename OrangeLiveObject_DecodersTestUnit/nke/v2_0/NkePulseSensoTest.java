...
@Slf4j
@DeviceDescription(name = "Watteco (NKE-Watteco) Pulse Senso 50-70-072 50-70-039 50-70-051", manufacturer = "WATTECO", docLink = "https://support.watteco.com/", 
version = { "1.0" ,
		"</h5>",
		"Clusters:<ul>",
...
public class NkePulseSensoTest extends TestBase {
    ...
    public void should_decode_000F_BinaryInput_attribut0402_cmd0A_payload_limit() throws JsDecodingException {
        /* real payload */
        String input = "110a000f040223FFFFFFFF";
        ...
        assertThat(binaryInput.getCounterCurrentValue()).isEqualTo(4294967295L);
    }

   

    @Test
    @PayloadDescription(name = "ClusterBinaryInput_PresentValue", description = "Cluster: Binary input, Attribut:PresentValue, Command: Report Attributes.")
    public void should_decode_000F_BinaryInput_attribut0055_cmd0A_payload() throws JsDecodingException {
