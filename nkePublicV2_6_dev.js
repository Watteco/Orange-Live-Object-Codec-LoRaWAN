 ...
 *   V2.6_dev (private)	:	27.07.2022 - Lisa DUTERTE <lduterte@watteco.fr> (WATTECO)
 */
...
var mapCluster = {
	...
	'8010' : '9Energy and Power Multi Metering',
...
var decode = function(encoded, dataMessage) {	
	try {	
			...
			if(isBatchPayload(encoded)) 
				...
				return decodeStandard(encoded,dataMessage);
	} catch (e) {		
				...
				for (var i=0; i<tagArrayLength;i++){
					...
					switch (tag) {
						...
						case 'BATCH_5070166_DEFAULT_PROFILE':
							...
							tagArray[tagArrayLength++] = 'BATCH_differentialPressures_Pa_L5_R1_T10';
							tagArray[tagArrayLength++] = 'BATCH_index_NoUnit_L6_R1_T10';
							tagArray[tagArrayLength++] = 'BATCH_states_NoUnit_L7_R1_T10';
							break;
